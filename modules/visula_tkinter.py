...
• Más de 10 graficas
• Algoritmo predictorios
• Graficas Especializadas
• Tecnología de renderizado de última generación

Nuestro equipo de desarrolladores, artistas y diseñadores trabajan 
incansablemente para llevar la magia del gaming a cada rincón del mundo.""",
...
🎮 INNOVACIÓN: Siempre buscando nuevas formas de sorprender a nuestros jugadores
🎨 CALIDAD: Cada detalle cuenta en la experiencia final
🤝 COMUNIDAD: Escuchamos y crecemos con nuestros jugadores
                 El nombre nuestro equipo es : Cincobits"""
                ,
                 font=("Helvetica", 12), fg="#cccccc", bg="#1e1e2f",
        ...
        tk.Label(team_frame, text="Cincobits:", font=("Helvetica", 14, "bold"),
